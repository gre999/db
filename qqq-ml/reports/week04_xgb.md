...
產生時間：2026-09-23 18:42 ET　·　預測存檔：2026-09-23T18:41
...
| year | Random walk | HAR | HAR-X | XGBoost | Random forest | XGB / HAR | HAR-X / HAR |
|---|---|---|---|---|---|---|---|
| 2019 | 0.308 | 0.22 | 0.206 | 0.212 | 0.213 | 0.964 | 0.936 |
| 2020 | 0.316 | 0.238 | 0.275 | 0.486 | 0.38 | 2.042 | 1.155 |
| 2021 | 0.311 | 0.216 | 0.199 | 0.244 | 0.237 | 1.13 | 0.921 |
| 2022 | 0.216 | 0.153 | 0.139 | 0.167 | 0.164 | 1.092 | 0.908 |
| 2023 | 0.204 | 0.131 | 0.116 | 0.123 | 0.118 | 0.939 | 0.885 |
| 2024 | 0.234 | 0.169 | 0.168 | 0.166 | 0.163 | 0.982 | 0.994 |
| 2025 | 0.37 | 0.277 | 0.287 | 0.263 | 0.282 | 0.949 | 1.036 |
| 2026 | 0.241 | 0.166 | 0.171 | 0.169 | 0.167 | 1.018 | 1.03 |
| all | 0.276 | 0.197 | 0.196 | 0.231 | 0.217 | 1.173 | 0.995 |

## 4. 跳躍期間與跳躍日

QLIKE：

| slice | n | Random walk | HAR | HAR-X | XGBoost | Random forest |
|---|---|---|---|---|---|---|
| all | 1939 | 0.276 | 0.197 | 0.196 | 0.231 | 0.217 |
| covid_2020 | 68 | 0.271 | 0.278 | 0.284 | 1.193 | 0.625 |
| jump_day | 219 | 0.838 | 0.629 | 0.481 | 0.667 | 0.535 |
| tariff_2025 | 56 | 0.243 | 0.34 | 0.42 | 0.252 | 0.314 |

RMSE（log）：

| slice | n | Random walk | HAR | HAR-X | XGBoost | Random forest |
|---|---|---|---|---|---|---|
| all | 1939 | 0.684 | 0.609 | 0.624 | 0.65 | 0.646 |
| covid_2020 | 68 | 0.699 | 0.701 | 0.762 | 1.176 | 0.972 |
| jump_day | 219 | 0.954 | 1.026 | 0.913 | 1.028 | 0.973 |
| tariff_2025 | 56 | 0.653 | 0.721 | 0.757 | 0.646 | 0.693 |
